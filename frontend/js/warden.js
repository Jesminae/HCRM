document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('feeForm').addEventListener('submit', async (e) => {
        ...
        const payload = {
            ...
            per_day_rate: document.getElementById('feeRate').value,
            hostel_group: document.getElementById('feeGroup').value
        };

        try {
            const res = await fetch('/api/warden/fees', {
                method: 'POST',
            ...
            if (res.ok) {
                ...
                if (document.getElementById('reportMonth').value === payload.month) {
                    loadStudentReport();
                }
            } else {
